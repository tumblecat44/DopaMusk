package com.dlrjsgml.doparich.feature.main.board.write
...
class WriteViewModel @Inject constructor(
    ...
    suspend fun uploadContent(){
        ...
        val writeWriter = RetrofitClient.myService.userInfo(getId())
        viewModelScope.launch {
            try{
                val writeContents = WriteDTO(writeContent,writeWriter.userName)
